...
const Layout: React.FC = () => {
  ...
  const getFillColor = (imageId: string) => {
    return selectedImage === imageId ? '#84FFAE75' : '#F9FAFB';
  };
        ...
        <div className="grid grid-cols-2 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-3 gap-4">
          ...
          >
            ...
            >
              ...
              <path d="M148 40H35.5C33.2909 40 31.5 41.7909 31.5 44V64.5C31.5 66.7091 33.2909 68.5 35.5 68.5H116C118.209 68.5 120 70.2909 120 72.5V147C120 149.209 121.791 151 124 151H148C150.209 151 152 149.209 152 147V44C152 41.7909 150.209 40 148 40Z" stroke="#615D5A" stroke-width="2" />
          ...
          >
           <svg
            ...
            >
              ...
              <path d="M45.7175 103.779C47.3575 103.779 48.6903 105.116 48.6903 106.769C48.6903 108.423 47.3575 109.76 45.7175 109.76C44.0775 109.76 42.7446 108.423 42.7446 106.769C42.7446 105.116 44.0775 103.779 45.7175 103.779Z" stroke="#615D5A" stroke-width="0.75" />
              <path d="M55.2824 103.779C56.9224 103.779 58.2552 105.116 58.2552 106.769C58.2552 108.423 56.9224 109.76 55.2824 109.76C53.6424 109.76 52.3096 108.423 52.3096 106.769C52.3096 105.116 53.6424 103.779 55.2824 103.779Z" stroke="#615D5A" stroke-width="0.75" />
              <path d="M45.7175 113.394C47.3575 113.394 48.6903 114.731 48.6903 116.385C48.6903 118.038 47.3575 119.375 45.7175 119.375C44.0775 119.375 42.7446 118.038 42.7446 116.385C42.7446 114.731 44.0775 113.394 45.7175 113.394Z" stroke="#615D5A" stroke-width="0.75" />
              <path d="M55.2824 113.394C56.9224 113.394 58.2552 114.731 58.2552 116.385C58.2552 118.038 56.9224 119.375 55.2824 119.375C53.6424 119.375 52.3096 118.038 52.3096 116.385C52.3096 114.731 53.6424 113.394 55.2824 113.394Z" stroke="#615D5A" stroke-width="0.75" />
            </svg>
          </div>
          <div
            className={`block cursor-pointer`}
          ...
          >
            ...
            >
              ...
              <path d="M66.5 109C66.5 107.343 67.8431 106 69.5 106H131.5C133.157 106 134.5 107.343 134.5 109V135C134.5 136.657 133.157 138 131.5 138H69.5C67.8431 138 66.5 136.657 66.5 135V109Z" stroke="#615D5A" stroke-width="2" />
          ...
          >
            ...
            >
              ...
              <path d="M157 40H44.5C42.2909 40 40.5 41.7909 40.5 44V64.5C40.5 66.7091 42.2909 68.5 44.5 68.5H125C127.209 68.5 129 70.2909 129 72.5V147C129 149.209 130.791 151 133 151H157C159.209 151 161 149.209 161 147V44C161 41.7909 159.209 40 157 40Z" stroke="#615D5A" stroke-width="2" />
