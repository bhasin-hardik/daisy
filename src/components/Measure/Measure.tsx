    ...
    >
      ...
      >
        ...
        <svg width="100%" height="auto" viewBox="0 0 584 372" fill="none" xmlns="http://www.w3.org/2000/svg" className='svg-wall'>
          <path d="M441.5 44H143.5C141.291 44 139.5 45.7909 139.5 48V112.919C139.5 115.128 141.291 116.919 143.5 116.919H360.239C362.448 116.919 364.239 118.71 364.239 120.919V324C364.239 326.209 366.029 328 368.239 328H441.5C443.709 328 445.5 326.209 445.5 324V48C445.5 45.7909 443.709 44 441.5 44Z" stroke={isWallA(1, wallFocus[0])} strokeWidth="2" />
          <path d="M363 117.5L447 116.994" stroke={isEitherWallFocused ? '#05EA45' : '#898484'} strokeWidth="3" />
          <path d="M364.5 117.5C364.896 192.481 364.087 250.519 364.484 325.5" stroke={isWallA(2, wallFocus[1])} strokeWidth="3" />
          <path d="M445.5 117C445.897 191.981 445.204 250.019 445.601 325" stroke={isWallA(2, wallFocus[1])}strokeWidth="3" />
          <path d="M363.5 328H446" stroke={isWallA(2, wallFocus[1])} strokeWidth="3" />
