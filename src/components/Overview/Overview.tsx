...
const Overview: React.FC = () => {
  ...
  const outerBoxStyle: React.CSSProperties = {
    width: '100%',
    maxWidth: '1102px', // Adjust as needed for your design
    ...
    <div style={containerStyle}>
      ...
      <div style={gridContainerStyle}>
        ...
        <div style={layoutBoxStyle}>
          ...
          <p style={layoutTextStyle}>Refrigerator Height: {getWallHeightFromLocalStorage(1)}</p>
        </div>
        <div></div>
        <div style={layoutBoxStyle}>
          <p style={layoutTextStyle}>Refrigerator Width: {getWallLengthFromLocalStorage(1)}</p>
        </div>
        ...
        <div style={layoutBoxStyle}>
          {numWalls === 1 ? (
            ...
            <p style={layoutTextStyle}>Refrigerator Height: {getWallHeightFromLocalStorage(2)}</p>
          )}
        </div>
        <div></div>
        <div style={layoutBoxStyle}>
          {numWalls === 1 ? (
            <p style={layoutTextStyle}>Refrigerator Width:</p>
          ) : (
            <p style={layoutTextStyle}>Refrigerator Width: {getWallLengthFromLocalStorage(2)}</p>
          )}
        </div>
      </div>
      <div style={wallDimensionsBoxStyle}>
      ...
      <div style={gridContainerStyle}>
        ...
        <div style={layoutBoxStyle}>
          ...
          <p style={layoutTextStyle}>Door Height: {getObstructionDataFromLocalStorage('A').door.height}</p>

        </div>
        <div></div>
        <div style={layoutBoxStyle}>
          <p style={layoutTextStyle}>Door Width: {getObstructionDataFromLocalStorage('A').door.width}</p>
        </div>
        <div></div>
        <div style={layoutBoxStyle}>
          <p style={layoutTextStyle}>Door Center: {getObstructionDataFromLocalStorage('A').door.center}</p>
        </div>
        ...
        <div style={layoutBoxStyle}>
          {numWalls === 1 ? (
            ...
            <p style={layoutTextStyle}>Door Height: {getObstructionDataFromLocalStorage('B').door.height}</p>
          )}
        </div>
        <div></div>
        <div style={layoutBoxStyle}>
          {numWalls === 1 ? (
            ...
            <p style={layoutTextStyle}>Door Width: {getObstructionDataFromLocalStorage('B').door.width}</p>
          )}
        </div>
        <div></div>
        <div style={layoutBoxStyle}>
          {numWalls === 1 ? (
            ...
            <p style={layoutTextStyle}>Door Center: {getObstructionDataFromLocalStorage('B').door.center}</p>
          )}
        </div>
      </div>
      ...
      <div style={gridContainerStyle}>
        ...
        <div style={layoutBoxStyle}>
          <p style={layoutTextStyle}>Dishwasher Width: {getApplianceDataFromLocalStorage('A').dish.width}</p>
        </div>
        <div></div>
        <div style={layoutBoxStyle}>
          <p style={layoutTextStyle}>Dishwasher Center: {getApplianceDataFromLocalStorage('A').dish.center}</p>
        </div>
        <div style={layoutBoxStyle}>
        ...
        <div style={layoutBoxStyle}>
          {numWalls === 1 ? (
            ...
            <p style={layoutTextStyle}>Dishwasher Width: {getApplianceDataFromLocalStorage('B').dish.width}</p>
          )}
        </div>
        <div></div>
        <div style={layoutBoxStyle}>
          {numWalls === 1 ? (
            ...
            <p style={layoutTextStyle}>Dishwasher Center: {getApplianceDataFromLocalStorage('B').dish.center}</p>
          )}
        </div>
      </div>
      ...
      <div style={gridContainerStyle}>
        ...
        <div style={{ display: 'flex', margin: '20px 20px', gap: '40px' }}>
          <svg width="53" height="58" viewBox="0 0 53 58" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <path
              ...
              fill={getSelectedImageForCabinet('cabinet3') === 'a' ? '#84FFAE75' : "#F9FAFB"} // Change the fill color when selected
            />
          ...
          <svg width="53" height="58" viewBox="0 0 53 58" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <path
              d="M0 7C0 3.13401 3.13401 0 7 0H46C49.866 0 53 3.13401 53 7V51C53 54.866 49.866 58 46 58H7C3.13401 58 0 54.866 0 51V7Z"
              fill={getSelectedImageForCabinet('cabinet3') === 'b' ? '#84FFAE75' : "#F9FAFB"} // Change the fill color when selected
          ...
          <svg width="53" height="58" viewBox="0 0 53 58" fill="none" xmlns="http://www.w3.org/2000/svg">
            {/* Add the SVG path for your image */}
            <path
              d="M0 7C0 3.13401 3.13401 0 7 0H46C49.866 0 53 3.13401 53 7V51C53 54.866 49.866 58 46 58H7C3.13401 58 0 54.866 0 51V7Z" fill={getSelectedImageForCabinet('cabinet3') === 'either' ? '#84FFAE75' : "#F9FAFB"} />
        ...
        <svg width="53" height="58" viewBox="0 0 53 58" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <path
              d="M0 7C0 3.13401 3.13401 0 7 0H46C49.866 0 53 3.13401 53 7V51C53 54.866 49.866 58 46 58H7C3.13401 58 0 54.866 0 51V7Z"
              fill={getSelectedImageForCabinet('cabinet2') === 'a' ? '#84FFAE75' : "#F9FAFB"} // Change the fill color when selected
            />
            <path opacity="0.6" d="M23.7722 22.5986H25.4362L29.1802 33.5106H27.7882L26.8282 30.5986H22.3962L21.4202 33.5106H20.0282L23.7722 22.5986ZM26.3962 29.3186L24.6362 23.8786H24.5882L22.8122 29.3186H26.3962Z" fill="#0E180A" />
          </svg>
          ...
          <svg width="53" height="58" viewBox="0 0 53 58" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <path
              d="M0 7C0 3.13401 3.13401 0 7 0H46C49.866 0 53 3.13401 53 7V51C53 54.866 49.866 58 46 58H7C3.13401 58 0 54.866 0 51V7Z"
              fill={getSelectedImageForCabinet('cabinet2') === 'b' ? '#84FFAE75' : "#F9FAFB"} // Change the fill color when selected
          ...
          <svg width="53" height="58" viewBox="0 0 53 58" fill="none" xmlns="http://www.w3.org/2000/svg">
            {/* Add the SVG path for your image */}
            <path
              d="M0 7C0 3.13401 3.13401 0 7 0H46C49.866 0 53 3.13401 53 7V51C53 54.866 49.866 58 46 58H7C3.13401 58 0 54.866 0 51V7Z" fill={getSelectedImageForCabinet('cabinet2') === 'either' ? '#84FFAE75' : "#F9FAFB"} />
        ...
        <svg width="53" height="58" viewBox="0 0 53 58" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <path
              d="M0 7C0 3.13401 3.13401 0 7 0H46C49.866 0 53 3.13401 53 7V51C53 54.866 49.866 58 46 58H7C3.13401 58 0 54.866 0 51V7Z"
              fill={getSelectedImageForCabinet('cabinet1') === 'a' ? '#84FFAE75' : "#F9FAFB"} // Change the fill color when selected
            />
            <path opacity="0.6" d="M23.7722 22.5986H25.4362L29.1802 33.5106H27.7882L26.8282 30.5986H22.3962L21.4202 33.5106H20.0282L23.7722 22.5986ZM26.3962 29.3186L24.6362 23.8786H24.5882L22.8122 29.3186H26.3962Z" fill="#0E180A" />
          </svg>
          ...
          <svg width="53" height="58" viewBox="0 0 53 58" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <path
              d="M0 7C0 3.13401 3.13401 0 7 0H46C49.866 0 53 3.13401 53 7V51C53 54.866 49.866 58 46 58H7C3.13401 58 0 54.866 0 51V7Z"
              fill={getSelectedImageForCabinet('cabinet1') === 'b' ? '#84FFAE75' : "#F9FAFB"} // Change the fill color when selected
          ...
          <svg width="53" height="58" viewBox="0 0 53 58" fill="none" xmlns="http://www.w3.org/2000/svg">
            {/* Add the SVG path for your image */}
            <path
              d="M0 7C0 3.13401 3.13401 0 7 0H46C49.866 0 53 3.13401 53 7V51C53 54.866 49.866 58 46 58H7C3.13401 58 0 54.866 0 51V7Z" fill={getSelectedImageForCabinet('cabinet1') === 'either' ? '#84FFAE75' : "#F9FAFB"} />
