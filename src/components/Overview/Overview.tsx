    ...
    exit={{ opacity: 0 }}>
      ...
      <div className='gridContainerStyle'>
        ...
        <div className='outer-svg'>
          <svg width='100%' height="58" viewBox="0 0 53 58" fill="none" xmlns="http://www.w3.org/2000/svg" className='svg-class'>
        ...
        <div className='outer-svg'>
          <svg width='100%' height="58" viewBox="0 0 53 58" fill="none" xmlns="http://www.w3.org/2000/svg"
            className='svg-class'>
            {/* Add the SVG path for your image */}
            <path
              d="M0 7C0 3.13401 3.13401 0 7 0H46C49.866 0 53 3.13401 53 7V51C53 54.866 49.866 58 46 58H7C3.13401 58 0 54.866 0 51V7Z"
